...
void LCD_Init(void)
{
  ...
  // MADCTL: MV|MX set for landscape (was 0x00/portrait). Rotation *direction*
  // (0x60 vs 0xA0) is a guess pending an on-hardware check - flip it here if
  // the image comes up upside-down or mirrored relative to the enclosure.
  LCD_WriteData(0x60);
